<%@ Page Title="" Language="C#" MasterPageFile="~/NhomToPhuocNguyen.master" AutoEventWireup="true" CodeFile="NhomToPhuocNguyen_Timkiem.aspx.cs" Inherits="Trang_NhomToPhuocNguyen_Timkiem" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder2" Runat="Server">
    <table style="width:100%;">
        ...
        <tr>
            <td>
                <cc1:CollectionPager ID="pager" runat="server" PageSize="6" MaxPages="4" >
                </cc1:CollectionPager>
            </td>
            <td>&nbsp;</td>
            <td>&nbsp;</td>
